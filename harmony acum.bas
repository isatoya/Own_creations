...
'Además, la macro elimina los valores duplicados de ese nuevo archivo si la persona lo desea.

'NOTA: La macro debe guardarse en la misma carpeta donde se encuentran las carpetas de cada mes; de lo contrario, no funcionará correctamente
...
'DESARROLLADOR: Isabel Montoya
    ...
    ' Si se encuentra un rango con advertencias, convertir a formato número
