...
'------------------- PRIMERA DESCARGA DE SAP Y ORGANIZAR EL ARCHIVO -------------------
    ...
    session.findById("wnd[1]/usr/ctxtDY_FILENAME").Text = año & mes & "." & "AUD PRIMA ADM" & ".XLS"
    ...
    Workbooks.Open Ruta_Mes & "\" & año & mes & "." & "AUD PRIMA ADM" & ".XLS"
    ActiveSheet.Cells.Select
    Selection.Copy
    Workbooks.Add
    ActiveSheet.Paste
    ActiveWorkbook.SaveAs Ruta_Mes & "\" & año & mes & "." & "AUD PRIMA ADM" & ".XLSX"
    ActiveWorkbook.Close SaveChanges:=True
    Workbooks(año & mes & "." & "AUD PRIMA ADM" & ".XLS").Close
    Kill Ruta_Mes & "\" & año & mes & "." & "AUD PRIMA ADM" & ".XLS"
    
    
    'Organizar documento
    Workbooks.Open Ruta_Mes & "\" & año & mes & "." & "AUD PRIMA ADM" & ".XLSX"
    Workbooks(año & mes & "." & "AUD PRIMA ADM" & ".XLSX").Activate
    Rows("1").Delete
    Rows("2").Delete
    Columns("A").Delete
    Columns("A:V").AutoFit
